                        ...
                        <div class="clearfix p20">
                                ...
                                <div class="form-group select-box">
                                    ...
                                    <select class="form-checkout form-control" name="delivery_area">
                                        ...
                                        <option @if((old('delivery_area') == $area->id) || (Auth::user()->location_id == $area->id)) selected @endif value="{{ $area->id }}">{{ $area->city }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="2" class="form-checkout form-control" name="address" placeholder="Address" id="address">{{ old('address') ? old('address') :  Auth::user()->address }}</textarea>
                                    <p class="ptsan-regular"></p>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <select  class="form-checkout form-control" id="dateSlot" name="delivery_date" >
                                        ...
                                        <option  @if(old('delivery_date') && old('delivery_date') == $date) selected @endif   value="{{ $date }}">
                                            @if($date == date('Y-m-d'))
                                    ...
                                    <select  class="form-checkout form-control" name="delivery_time" id="timeSlot">
                                        @if (old('delivery_time'))
                                            <option  value="{{ old('delivery_time')}}" selected>{{ old('delivery_time') }}</option>
                                        @else
