@extends('front.master.master',['hideFooterCart'=>true])
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <div class="form bg-white bg-shadow">
                                ...
                                <div class="p30">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input class="starterPrice my-radio" type="checkbox"
                                                   name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}><label
                                    ...
                                    <div class="account-info text-center clearfix width-res my-2">
                                        <h5 class="color-dark">
                                            <a href="{{ route('password.request') }}">Forgot Password?</a>
                                        </h5>
                                    </div>
                                    <a href="{{ url('register') }}">
                                        <button class="button button-md bg-dark2 color-white mb20 theme-background"
                                                style="width: 100%">Create New Account
                                        </button>
                                    </a>
