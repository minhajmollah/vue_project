        ...
        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ getSum(products.data, 'stock_quantity') }}</th>
                                        <th>{{ getSum(products.data, 'current_quantity') }}</th>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
            ...
            <div class="ibox animated fadeInRightBig">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a title="Excel Sample for Bulk Store"
                           :href="url+'admin/export?req=stock&keyword='+this.keyword+'&category='+this.category.id + '&sub_category='+this.sub_category.id+'&sub_sub_category='+this.sub_sub_category.id+'&brand='+this.brand.id+'&bulkstore=yes'"
                           class="btn btn-info btn-sm"><i class="fa fa-download" aria-hidden="true"></i> Sample
                            Excel</a>

                        <a title="Download Excel"
                           :href="url+'admin/export?req=stock&keyword='+this.keyword+'&category='+this.category.id + '&sub_category='+this.sub_category.id+'&sub_sub_category='+this.sub_sub_category.id+'&brand='+this.brand.id+'&bulkstore=no'"
                           class="btn btn-success btn-sm"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>

                        <a title="Download PDF"
                           :href="url+'admin/product-report-pdf?keyword='+this.keyword+'&category='+this.category.id + '&sub_category='+this.sub_category.id+'&sub_sub_category='+this.sub_sub_category.id+'&brand='+this.brand.id"
                           class="btn btn-primary btn-sm"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>

                        <a title="Print"
                           :href="url+'admin/product-report-print?keyword='+this.keyword+'&category='+this.category.id + '&sub_category='+this.sub_category.id+'&sub_sub_category='+this.sub_sub_category.id+'&brand='+this.brand.id"
