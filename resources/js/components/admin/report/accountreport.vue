        ...
        <div class="col-lg-12">
            <div class="ibox animated fadeInRightBig">
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="col-sm-3 m-b-xs">
                            <v2-datepicker lang="en" format="yyyy-MM-DD" v-model="singleDate"
                                           :picker-options="pickerOptions2" @change="getMethodData()"></v2-datepicker>
                        </div>
                        <div class="col-sm-3 m-b-xs">
                            <v2-datepicker-range lang="en" format="yyyy-MM-DD" v-model="rangeDate"
                                                 :picker-options="pickerOptions"
                                                 @change="getMethodData()"></v2-datepicker-range>
                        </div>
                            ...
                            <div class="table-responsive text-center">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ getSum(pay_amount.data, 'amount') }}</th>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
            ...
            <div class="ibox animated fadeInRightBig">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a :href="url+'admin/export?req=payment&methods='+this.paymethod.id+'&range='+this.rangeDate+'&singledate='+this.singleDate"
                           class="btn btn-success btn-sm"><i class="fa fa-file-excel-o" aria-hidden="true"></i>
                            Excel</a>
                        <a :href="url+'admin/product-amount-report-pdf?methods='+this.paymethod.id+'&range='+this.rangeDate+'&singledate='+this.singleDate"
                           class="btn btn-primary btn-sm"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>

                        <a :href="url+'admin/product-amount-report-print?methods='+this.paymethod.id+'&range='+this.rangeDate+'&singledate='+this.singleDate"
...
export default {
    ...
    methods: {
        ...
        getMethodData(page = 1) {
            ...
            this.isLoading = true;
            axios.get(base_url
                      + 'admin/payment-method-wise-amount?page='
                      + page
                      + '&methods='
                      + this.paymethod.id
                      + '&range='
