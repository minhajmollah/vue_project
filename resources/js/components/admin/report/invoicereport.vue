        ...
        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ getSum(products.data, 'total_item') }}</th>
            ...
            <div class="ibox animated fadeInRightBig">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a :href="url+'admin/export?req=invoice&range='+this.rangeDate+'&city='+this.city.id + '&report_type=normal'"
                           class="btn btn-success btn-sm"><i class="fa fa-file-excel-o" aria-hidden="true"></i>
                            Excel</a>
                        <a :href="url+'admin/product-invoice-report-pdf?range='+this.rangeDate+'&city='+this.city.id + '&report_type=normal'"
                           class="btn btn-primary btn-sm"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>

                        <a :href="url+'admin/product-invoice-report-print?range='+this.rangeDate+'&city='+this.city.id + '&report_type=normal'"
    ...
    methods: {
        ...
        getAmountSum(array){
            if (array !== undefined){
                let total = 0;
                array.forEach((element) => {
                    total += parseFloat(element.total_amount - element.coupon_discount);
                });
