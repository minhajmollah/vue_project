                ...
                <div class="modal-body">
                    <form @submit.prevent="save()">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Slider Image (1920 X 420 for desktop and 500 X 600 for mobile)</label
                                    ><small>
                                    Image best size is (1920 X 420 for desktop and 500 X 600 for mobile), all image must be same
                                    size.</small
                                >
                                    <br/>
                                    <div
    ...
    methods: {
        getSlider(id) {
            axios.get(base_url + "admin/slider/" + id + "/edit").then((response) => {
                ...
                this.form.is_mobile    = response.data.data.is_mobile;
