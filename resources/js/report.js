...
Vue.component('view-datewisesalesreport', require('./components/admin/report/datewisesalesreport.vue').default);
Vue.component('view-invoicereport', require('./components/admin/report/invoicereport.vue').default);
Vue.component('view-datewiseinvoicereport', require('./components/admin/report/datewiseinvoicereport.vue').default);
Vue.component('view-cusomerwiseinvoicereport', require('./components/admin/report/customerwiseinvoicereport.vue').default);
