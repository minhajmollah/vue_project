...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $slider->is_mobile     = $request->is_mobile;
    ...
    public function sliderStatus($id)
    {
        try {
            ...
            $slider->status = $slider->status == AllStatic::$active
                ? AllStatic::$inactive
                : AllStatic::$active;

            $message = $slider->status == AllStatic::$active
                ? 'Slider Activated!'
                : 'Slider Deactivated!';
