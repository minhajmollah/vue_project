...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        (1, 'Farmingo | Fresh Fruits & Vegetables', '5ed50b0000acd.jpeg', 'sitemap.com', 'Farmingo, Farmingo ecommerce, Farmingo ecommerce, Farmingo , Farmingo , Farmingo', 'Farmingo ',
        'Farmingo is an ecommerce solution for both Fresh Fruits & Vegetables', '2020-02-09 00:05:09', '2020-06-01 08:04:49')");
      ...
      (1, 'Farmingo', NULL, 'Savar Baliapur', '2020 all right reserve by@Farmingo', '01122333456', 'business@Farmingobd.com', 'https://facebook.com', 'https://twitter.com', 'https://youtube.com', '5ed50bc056bf0.png', '5ed50bc05fd25.png', '5ed50bc066add.png', '#E3106E', 1, 0, 1,1,'2020-02-10 03:00:06', '2020-07-15 09:40:09')");
        ...
        // Email setting
        DB::insert("INSERT INTO `emails` (`id`, `driver`, `host`, `port`, `username`, `password`, `encryption`, `from_address`, `from_name`, `status`, `created_at`, `updated_at`) VALUES (1, 'smtp', 'mailtrap.io', '587', 'Farmingobd@yahooo.com', 'your_password', 'tls', 'noreply@yourgmail.com', 'Fresh', '1', NULL, NULL);");
