...
Route::get('datewise-sales-report',['as' => 'datewise.sales.report','uses' => 'Chart\ReportController@datewiseSalesReport']);
Route::get('datewise-invoice-report',['as' => 'datewise.invoice.report','uses' => 'Chart\ReportController@datewiseInvoiceReport']);
Route::get('customerwise-order-report',['as' => 'customerwise.order.report','uses' => 'Chart\ReportController@customerwiseOrderReport']);
